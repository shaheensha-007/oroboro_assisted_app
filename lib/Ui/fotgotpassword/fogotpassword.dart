...
class _FogotpasswordState extends State<Fogotpassword> {
  ...
  listener: (context, state) {
    ...
    if(state is ForgotpasswordblocLoaded){
      isForgotpassword = BlocProvider.of<ForgotpasswordBloc>(context).isforgotpassword;
    }
  ...
  child: ElevatedButton(style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor: const Color(0xff284389)
                                  ...
                                  final forgotpasswordvalid=forgotpasswordmobilekey.currentState?.validate();
                                  if(forgotpasswordvalid==true){
                                    BlocProvider.of<ForgotpasswordBloc>(context).add(FetchForgotpassword(Username: forgotusername.text, Mobilenumber: forgotmobile.text));
                                ...
                                Center(
                                  child:  Container(
                                    ...
                                    child: TextButton(onPressed:
                                      ...
                                      children: [
                                        Icon(Icons.arrow_back_outlined,color: Color(0xff284389),),
                                        Text("Back to Sign in",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w800,color: Color(0xff284389)),)
                                      ],
                                    )),
                                  ),
                                )
