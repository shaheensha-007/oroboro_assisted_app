...
/// controllers
late MonthincomeModel isincomemonth;
            ...
            Padding(
              ...
              child: Form(
                ...
                BlocListener<MonthincomeBloc, MonthincomeState>(
                  listener: (context, state) {
                    ...
                    if(state is MonthincomeblocLoaded){
                      isincomemonth=BlocProvider.of<MonthincomeBloc>(context).ismonthlyincome;
                      if(isincomemonth.status.toString()=="Success"){

                      }else{
                        _showErrorSnackBar(isincomemonth.errorMessage.toString());
                      }
                    }
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        validator: (value){
                          if(value!.isEmpty){
                            return 'please enter Reference 1 age';
                          }
                        },
                        style: const TextStyle(fontSize: 14,
                            fontWeight: FontWeight.w800,
                ...
                height: mheight * 0.03,
                            ...
                            const Text("Reference 2", style: TextStyle(fontSize: 18,
                  fontFamily: "regulartext",
                  fontWeight: FontWeight.w800),),
                            SizedBox(
                height: mheight * 0.02,
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        validator: (value){
                          if(value!.isEmpty){
                            return 'please Enter Reference 2 Age';
                          }
                        },
                        style: const TextStyle(fontSize: 14,
                            fontWeight: FontWeight.w800,
