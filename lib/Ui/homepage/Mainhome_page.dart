         ...
         Center(
           child:SingleChildScrollView(
             child: Column(
               children: [
                 ...
                 Center(
                   child: Column(
                     ...
                     children: [
                       const Image(image: AssetImage("assets/oroboro.png"),),
                       SizedBox(
                         height: mheight*0.02,
                       ),
                       const Text("Shivan Electronics",style: TextStyle(fontSize: 25,fontFamily:"headers"),),
                       const Text("Jetfinix Services",style: TextStyle(fontSize: 18,fontFamily:"shorts"),)
                     ],
                   ),
                 ),
                 SizedBox(
                           ...
                           children: [
                             ...
                             GestureDetector(
                               ...
                               child: Container(
                                 child: Column(
                                   children: [
                                     const Center(child: Image(image: AssetImage("assets/Loan.png"),)),
                                     SizedBox(
                                       height: mheight * 0.01,
                                     ),
                                     const Text("Loan", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                     const Text("Details", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),)
                                   ],
                                 ),
                               ),
                             ),
                             ...
                             Padding(
                               ...
                               child: GestureDetector(
                                 ...
                                 child: Container(
                                   child: Column(
                                     children: [
                                       const Center(child: Image(image: AssetImage("assets/emi calculator.png"),)),
                                       SizedBox(
                                         height: mheight * 0.01,
                                       ),
                                       const Text("EMI", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                       const Text("Calculator", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),)
                                     ],
                                   ),
                                 ),
                               ),
                         ...
                         child: Row(
                           ...
                           children: [
                             Container(
                               child: Column(
                                 children: [
                                   const Center(child: Image(image: AssetImage("assets/notification.png"),)),
                                   SizedBox(
                                     height: mheight * 0.01,
                                   ),
                                   const Text("Notification", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                 ],
                               ),
                             ),
                             const Spacer(),
                             GestureDetector(
                               ...
                               child: Container(
                                 child: Column(
                                   children: [
                                     const Center(child: Image(image: AssetImage("assets/Ledger.png"),)),
                                     SizedBox(
                                       height: mheight * 0.01,
                                     ),
                                     const Text("Ledger", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                   ],
                                 ),
                               ),
                             ),
                             ...
                             GestureDetector(
                               ...
                               child: Padding(
                                 ...
                                 child: Container(
                                   child: Column(
                                     children: [
                                       const Center(child: Image(image: AssetImage("assets/cash-flow 1.png"),)),
                                       SizedBox(
                                         height: mheight * 0.01,
                                       ),
                                       const Text("Cash Flow", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                     ],
                                   ),
                                 ),
                               ),
                           ...
                           child: Row(
                             ...
                             children: [
                               Container(
                                 child: Column(
                                   children: [
                                     const Center(child: Image(image: AssetImage("assets/payment.png"),)),
                                     SizedBox(
                                       height: mheight * 0.01,
                                     ),
                                     const Text("Payment", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                   ],
                                 ),
                               ),
                               const Spacer(),
                               GestureDetector(
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     child: Column(
                                       children: [
                                         const Center(child: Image(image: AssetImage("assets/Schedules icon.png"),)),
                                         SizedBox(
                                           height: mheight * 0.01,
                                         ),
                                         const Text("Schedules", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                       ],
                                     ),
                                   ),
                                 ),
                               ...
                               GestureDetector(
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     child: Column(
                                       children: [
                                         const Center(child: Image(image: AssetImage("assets/mandateStatus.png"),)),
                                         SizedBox(
                                           height: mheight * 0.01,
                                         ),
                                         const Text("Mandate Status", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                       ],
                                     ),
                                   ),
                                 ),
                       ...
                       Padding(
                         ...
                         child: Column(
                           ...
                           children: [
                             Row(
                               children: [
                                 const Text("Year", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                                 SizedBox(
                                   width: mwidth * 0.02,
                                 ),
                                 Container(
                                 ...
                                 const Text("Month", style: TextStyle(fontSize: 18, fontFamily: "regulartext", color: Colors.white),),
                               ],
                             ),
                             SizedBox(
                               height: mheight * 0.03,
                                     ...
                                     child: Container(
                                       ...
                                       child: Row(
                                         ...
                                         children: [
                                           Padding(
                                             padding: EdgeInsets.only(left: mwidth * 0.1),
                                             child: const Center(child: Image(image: AssetImage("assets/graph-line2 1.png"))),
                                           )
                                         ],
                                       ),
                                     ),
              ...
              Row(
                children: [
                  const Text("Show entries",style: TextStyle(fontSize: 14,fontFamily: "boldtext",fontWeight: FontWeight.w800)),
                  SizedBox(
                    width: mwidth*0.02,
                  ),
                  Container(
                    ...
                    child:TextFormField(
                      ...
                      style: const TextStyle(fontSize: 12,fontWeight: FontWeight.w800,fontFamily: "regulartext"),
              ...
              Row(
                children: [
                  const Text("Search",style: TextStyle(fontSize: 14,fontFamily: "boldtext",fontWeight: FontWeight.w800)),
                  SizedBox(
                    width: mwidth*0.02,
                  ),
                  Container(
                    ...
                    child:TextFormField(
                      ...
                      style: const TextStyle(fontSize: 12,fontWeight: FontWeight.w200,fontFamily: "regulartext"),
                      decoration: const InputDecoration(
                        border: InputBorder.none,
                        enabledBorder: InputBorder.none,
                        errorBorder: InputBorder.none,
