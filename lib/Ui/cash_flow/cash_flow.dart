          ...
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: const Text("Cash Flow",style: TextStyle(fontSize:18,fontFamily: "boldtext",fontWeight: FontWeight.w800),),
              ),
              SizedBox(
                height: mheight*0.03,
              ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      const Text("Narration :",style:TextStyle(fontSize: 12,fontFamily:"shorts",fontWeight: FontWeight.bold,)),
                                      SizedBox(
                                        width: mwidth*0.01,
                                      ),
                                      Padding(
                                        padding:EdgeInsets.only(right: mwidth*0.05,top: mheight*0.02),
                                        child: const Text("Lorem Ipsum is   dummy text of the printing and\n typesetting industry.",style:TextStyle(fontSize: 10,fontFamily:"shorts",fontWeight: FontWeight.bold,)),
                                      ),
                                    ],
                                  )
                                ],
