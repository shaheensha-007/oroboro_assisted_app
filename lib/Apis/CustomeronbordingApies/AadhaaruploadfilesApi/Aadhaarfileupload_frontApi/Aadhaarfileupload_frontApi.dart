...
class Aadhaarfileupload_frontApi {
  ApiClient_1 apiClient_1 = ApiClient_1();
  String trendingpath = 'gateway/LOS/Doc_OCR';
  Future<AadhaaruploadfilesModel> postAadhaarfrontuploadsdata(String userid,String identitytype,String Identityvalue,String docid_value,String doctype,String docbase64,applicationid,BuildContext context) async {
    var body = {
      'ApiUserId': "Test",
      'UserId': userid,
